...
from Models.shared_transformer import ScheduledOptim, ShareEmbeddingTransformer
...
if __name__ == "__main__":
    model = ShareEmbeddingTransformer(kwargs['vocab_size'], kwargs['max_seq_length'],
                                      kwargs['d_model'], kwargs['nhead'], kwargs['num_encoder_layers'],
